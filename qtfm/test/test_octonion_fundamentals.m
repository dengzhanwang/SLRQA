...
% Now a more complex test to check out the matrix multiply and conjugate
% transpose operations (this is a convenient way to test the matrix
% multiply).

A = octonion(randi(10, 3), randi(10, 3), randi(10, 3), randi(10, 3), ...
             randi(10, 3), randi(10, 3), randi(10, 3), randi(10, 3));
B = octonion(randi(10, 3), randi(10, 3), randi(10, 3), randi(10, 3), ...
             randi(10, 3), randi(10, 3), randi(10, 3), randi(10, 3));

check(all(all(A * B == (B' * A')')), ...
     'Error in matrix multiplication test 1');
check(all(all(vector(A) * B == (B' * vector(A)')')), ...
     'Error in matrix multiplication test 2');
check(all(all(A * vector(B) == (vector(B)' * A')')), ...
     'Error in matrix multiplication test 3');

disp('Passed');

end

% $Id: test_octonion_fundamentals.m 1114 2021-02-01 18:59:02Z sangwine $
