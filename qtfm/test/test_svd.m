...
A = quaternion(zeros(5,5),randn(5,5),randn(5,5),randn(5,5));
...
% TODO
disp('Warning: SVD is not currently tested on complex quaternion matrices.')
...
% $Id: test_svd.m 1113 2021-02-01 18:41:09Z sangwine $
