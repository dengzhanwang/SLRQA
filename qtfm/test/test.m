...
% Copyright © 2005, 2006, 2009, 2010, 2013, 2017
...
test_polar
toc
disp('All numeric tests completed without error.')

V = ver('symbolic');

if isempty(V)
    disp('Symbolic Toolbox is not present, skipping tests.')
else
    % Measure the time separately for testing symbolic function, so that we can
    % see any effect of the symbolic code on the numeric computations.
    tic
    test_symbolic
    toc
end
...
% $Id: test.m 1113 2021-02-01 18:41:09Z sangwine $
