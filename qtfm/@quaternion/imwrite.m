...
C = class(Q.x); % We want to call this once only, so we suppress the code
                % analyser warnings on the next line.
if strcmp(C, 'uint8') || strcmp(C, 'uint16') || strcmp(C, 'double') %#ok<*STISA>
...
% $Id: imwrite.m 1113 2021-02-01 18:41:09Z sangwine $
