...
% Copyright © 2008, 2016 Stephen J. Sangwine, Nicolas Le Bihan and Salem Said.
...
while true
    ...
    if P            % be too, but e will be a full quaternion. Therefore
        m = vector(m); % rounding error can result in a non-zero scalar part
...
% $Id: spherical_mean.m 1113 2021-02-01 18:41:09Z sangwine $
