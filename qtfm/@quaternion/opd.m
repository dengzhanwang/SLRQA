...
if ispure(a) && nargin == 2
    
    % If a is a pure quaternion, and b is omitted, the above formulae
    % result by definition in a pure quaternion result for p, hence we
...
% $Id: opd.m 1113 2021-02-01 18:41:09Z sangwine $
