...
% The Study determinant is the square of the Dieudonné determinant and is
% much faster to calculate, but it may not be accurately real, whereas the
% Dieudonné determinant is real by definition.
%
...
switch d
case {'Dieudonné', 'Dieudonne'}
    
    % The Dieudonné determinant is defined by diagonalising the matrix.
    ...
    % Dieudonné determinant using the SVD (it is the product of the
    % singular values).
...
case 'Study'
    ...
    % square of the Dieudonn� determinant.
...
% $Id: det.m 1113 2021-02-01 18:41:09Z sangwine $
