...
% Copyright © 2008, 2016 Stephen J. Sangwine and Nicolas Le Bihan.
...
if ispure(q1) && ispure(q2) % If both input parameters were pure, so must
    y = vector(y);          % be the result, by definition, so remove any
end                         % scalar part.

end

% $Id: slerp.m 1113 2021-02-01 18:41:09Z sangwine $
