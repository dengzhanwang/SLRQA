...
P = fliplr(poly(omega(A))); % TODO poly doesn't exist for symbolic. Note 2.
...
% Note 2. This code currently falls over for symbolic matrices because the
% poly function 'has been removed' from Matlab for symbolic matrices. The
% charpoly function is recommended instead. However, this works VERY much
% slower for numeric matrices (why?). Fixing this may be involved and since
% it is unlikely that linv will run in sensible amounts of time for
% symbolic octonion matrices, it doesn't seem like a priority in 2021.

% $Id: linv.m 1127 2021-08-30 19:35:41Z sangwine $
